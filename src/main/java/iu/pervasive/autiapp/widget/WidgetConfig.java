...
package iu.pervasive.autiapp.widget;
...
public class WidgetConfig extends Activity implements OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (extras != null) {
            setContentView(iu.pervasive.autiapp.R.layout.widgetconfig);

            ColorPreviewButton textcolor = (ColorPreviewButton) findViewById(iu.pervasive.autiapp.R.id.textcolor);
            textcolor.setOnClickListener(this);
            textcolor.setColor(Color.WHITE);
            ColorPreviewButton bgcolor = (ColorPreviewButton) findViewById(iu.pervasive.autiapp.R.id.bgcolor);
        ...
        dialog.setOnColorChangedListener(new ColorPickerDialog.OnColorChangedListener() {
            ...
            public void onColorChanged(int color) {
                ...
                getSharedPreferences("Widgets", Context.MODE_PRIVATE).edit()
                        .putInt((v.getId() == iu.pervasive.autiapp.R.id.bgcolor ? "background_" : "color_") + widgetId,
                                color).apply();
            }
        });
        dialog.show();
